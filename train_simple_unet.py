...
test_img = cv2.imread('E:/PROF. QAISER ABBAS/Segmented Images/Greyscale_Segmented_images/Segmented_Grayscale_Image_05.png', 0)
...
segmented = (model.predict(test_img_input)[0,:,:,0] > 0.02).astype(np.uint8)
...
img = cv2.imread('E:\Shandong University\Dr. Imran Quershi\Another Work\p-Datasets\Mask/P0213.bmp')  #Read as color (3 channels)
img_grey = img[:,:,0]
...
plt.imshow(img2)
plt.axis("off")
#plt.imsave('D:\Shandong University\Dr. Imran Quershi\Database\Segmentation\Instance Segmentation/LESION1.tif', img2)
