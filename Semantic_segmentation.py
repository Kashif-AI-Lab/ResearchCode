...
print(os.listdir("semantic/"))

SIZE = 512 #Resize images

train_images = []

for directory_path in glob.glob("semantic/train_images"):
...
train_masks = [] 
for directory_path in glob.glob("semantic/mask_images"):
...
#READ EXTERNAL IMAGE...
test_img = cv2.imread('E:/Shandong University/Dr. Imran Quershi/New_project/Histo_Equal_Img/08.jpg', cv2.IMREAD_COLOR)       
